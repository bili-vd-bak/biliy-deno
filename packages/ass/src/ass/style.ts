import { formatColor, getDecoratingColor } from "../util/index.ts";
...
export default ({
	...
	const colorStyle =
		`${primaryColorValue},${primaryColorValue},${outlineColorValue},${backColorValue}`;

	const boldValue = bold ? "1" : "0";
	const fontStyle =
		`${boldValue},0,0,0,100,100,0,0,1,${outline},${shadow},7,0,0,0,0`;
